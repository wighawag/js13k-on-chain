...
<section class="py-2 px-4 text-center">
	...
	<div class="pt-3 pb-4">
		...
		<CopyBlock
			...
			text={`npx degit wighawag/js13k-on-chain your-app-folder`}
		/>
		<p class="mt-6 text-base-300">
			Find out more on
			<a class="underline" href="https://github.com/wighawag/js13k-on-chain#readme" target="_blank" rel="noreferrer"
				>github</a
			>
		</p>
	</div>
